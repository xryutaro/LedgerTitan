...
#[derive(Debug)]
pub struct LedgerTitanProcessor {
    verbose: bool,
    processed_count: usize,
}

impl LedgerTitanProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting LedgerTitan processing");
    
    let mut processor = LedgerTitanProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = LedgerTitanProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = LedgerTitanProcessor::new(false);
